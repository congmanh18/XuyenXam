...
type CategoryHandler interface {
	...
	HandleGetProductByCategory(c echo.Context) error
...
type categoryHandleImpl struct {
	...
	getProductByCategoryUseCase category_usecase.GetProductsByCategoryUseCase
...
func NewCategoryHandler(inject CategoryHandleInject) CategoryHandler {
	return &categoryHandleImpl{
		...
		getProductByCategoryUseCase: inject.GetProductByCategoryUseCase,
